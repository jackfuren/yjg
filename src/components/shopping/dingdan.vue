  ...
  <div class="box">
    <div class="box-container">
      <div class="nav-top">
        <div class="nav">
          ...
          <div class="dz">
            ...
            <div class="dz-a">
              <p>{{dataList.getusername}} <span>{{dataList.mobile}}</span></p>
      ...
      <div class="concat">
        ...
        <p class="concat-c">运费(快递) <span>￥{{dataList.freight}}</span>
        </p>
		<p class="concat-ml">店铺优惠 <span>￥{{dataList.couponprice}}</span> </p>
        <div class="concat-d">
