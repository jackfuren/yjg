  ...
  <div class="box">
    ...
    <div  class="concat">
      ...
      <div class="concat-b" v-for="(item ,index) in listData.goods" :key="index">
        ...
        <p class="tui" @click="tui(item)">退款</p>
      </div>
      ...
      <p class="concat-e"> 已付款: <span> ￥{{listData.money}}</span></p>
    </div>
    <div class="xin">
      <p>订单信息</p>
      <p>订单编号
    ...
    <div class="footer">
      <div><p @click="wuliu()">查看物流</p></div>
      <div><p @click="shouhuo()">确认收货</p></div>
    </div>
    ...
    methods: {
      ...
      wuliu() {
        ...
        this.$router.push({
          name: 'wl',
					query:{
					  dan:this.listData.expresssn,
						expresscom:this.listData.expresscom,
					}
        })
      },
      onCopy: function (e) {
