<template>
  <div class="box">
    ...
    <div class="concat">
      ...
      <textarea class="textarea-inherit" v-model="content" placeholder="请对商品做个完整的评价吧！让更多的人了解它！"></textarea>
    ...
    <div class="xing">
      ...
      <van-rate v-model="A" allow-half void-icon="star" void-color="#eee" class="xing-top" />
      <van-rate v-model="B" allow-half void-icon="star" void-color="#eee" class="xing-bottom" />
    </div>
