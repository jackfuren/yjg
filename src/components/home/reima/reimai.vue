<template>
  <div class="box">
    <div class="box-container">
      ...
      <div
        class="swiper-container index_carsel"
        style="padding:15px;background: #FFFFFF;margin-top:0.9rem;"
      >
      ...
      <div class="brandd">
        ...
        <div class="product">
          <div class="product-div" v-for="(item,index) in arrList" @click="details(item.id)">
            ...
            <p>
              <van-icon
                v-show="item.is_collection == 0 ? true :false"
                color="#F21D13"
                name="star-o"
                size="0.4rem"
              />
              <van-icon
                v-show="item.is_collection == 1 ? true :false"
                color="#FBA39A"
                name="star"
                size="0.4rem"
              />
